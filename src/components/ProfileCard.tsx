...
export default function ProfileCard() {
  return (
    <Card className="mb-8 transition-all duration-300 hover:shadow-lg animate-fade-in-up">
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row items-start gap-6">
          <Avatar className="w-32 h-32 transition-transform duration-300 hover:scale-105 animate-fade-in-up">
            <AvatarImage src="/logo.JPG" alt="张晋哲" />
            <AvatarFallback>张晋哲</AvatarFallback>
          </Avatar>
          <div className="flex-1">
            <h1 className="text-3xl font-bold mb-2 transition-colors duration-300 animate-fade-in-up">张晋哲</h1>
            <p className="text-xl text-muted-foreground mb-4 transition-colors duration-300 animate-fade-in-up">全栈工程师</p>
            <p className="text-foreground mb-6 leading-relaxed transition-colors duration-300 animate-fade-in-up">
            ...
            <div className="flex gap-3 mt-4 animate-fade-in-up">
              <Button variant="outline" size="sm" asChild className="transition-all duration-300 hover:shadow-md animate-fade-in-up">
